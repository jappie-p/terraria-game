...
export class Game {
  ...
  update(dt) {
    ...
    // Always update nearby workstations for crafting, even when UI is open
    ...
    // Check for player interactions (e.g. opening chests)
    if (this.player.interactionRequest) {
      ...
      if (request.type === 'CHEST') {
        ...
        // Show player inventory too if hidden? InventoryScreen is usually separate. 
        // But ChestInventoryUI renders its own player inventory view.
      }
