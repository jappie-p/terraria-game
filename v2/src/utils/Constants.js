...
export const TILE_PROPS = {
  ...
  [TILE.WATER]: { solid: false, health: 0, transparent: true, fluid: true },
  [TILE.LAVA]: { solid: false, health: 0, transparent: true, fluid: true, damage: 10 },
  [TILE.WORKBENCH]: { solid: true, health: 150, transparent: true, workstation: 'WORKBENCH' },
  [TILE.FURNACE]: { solid: true, health: 200, transparent: false, workstation: 'FURNACE' },
  [TILE.LOG]: { solid: false, health: 150, transparent: false },
  [TILE.SNOW]: { solid: true, health: 50, transparent: false },
  [TILE.CACTUS]: { solid: true, health: 80, transparent: false },
  [TILE.CHEST]: { solid: true, health: 150, transparent: false, container: true },
};
...
export const TILE_COLORS = {
  ...
  [TILE.WORKBENCH]: '#8B4513', // Brown wood
  [TILE.FURNACE]: '#696969', // Gray stone
  [TILE.LOG]: '#5C3317', // Dark wood
  [TILE.SNOW]: '#FFFFFF', // White
  [TILE.CACTUS]: '#228B22', // Green
  [TILE.CHEST]: '#8B4513', // Brown wood
};
